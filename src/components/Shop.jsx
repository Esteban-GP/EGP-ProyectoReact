                ...
                <div className='w-50 ' style={{ fontFamily: 'Formula1Regular, sans-serif' }}>
                    ...
                    {showCheckboxes && (
                        <div className="mt-2 space-y-5">
                            ...
                            <label className="flex items-center space-x-2"><input type="checkbox" value="kick" checked={kickFilter} onChange={() => setKickFilter(!kickFilter)} /><img src="/sauber-logo.png" alt="Kick Sauber" className="w-9"/> <span>Kick Sauber</span></label>
