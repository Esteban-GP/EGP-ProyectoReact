    ...
    <>
      <nav className='shadow-lg flex items-center'>
        ...
        <div className="flex items-center">
          ...
          <Link to="/" className="px-4"><button type="button" className="text-white bg-gradient-to-r from-red-400 via-red-500
                                                                         ...
                                                                         px-5 py-2.5 text-center me-2 mb-2 mt-2">Sing Up</button></Link>
        </div>
      </nav>
    </>
  )
